                ...
                <div class="px-6 py-4">
                    <form action="{{ route('boxes.update', $box->id) }}" method="POST">
                        ...
                        <div class="flex justify-center">
                            <button type="submit" class="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded focus:outline-none focus:ring focus:ring-blue-300">Update Box</button>
                        </div>
                    </form>
                </div>
            </div>
