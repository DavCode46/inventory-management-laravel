            ...
            <div class="bg-white rounded-xl overflow-hidden shadow-lg p-8">
                ...
                <form method="POST" action="{{ route('loans.update', $loan->id) }}">
                    ...
                    <div class="flex justify-center">
                        <button type="submit" class="px-6 py-3 bg-blue-600 rounded-lg text-white font-semibold hover:bg-blue-700focus:ring-blue-400 focus:ring-opacity-75 transition-colors duration-300">Mark as returned</button>
                    </div>
                </form>
            </div>
        </div>
